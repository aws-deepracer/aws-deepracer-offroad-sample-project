...
namespace SysCtrl {
    ...
    #define OFFROAD_DRIVE_TOPIC "/deepracer_offroad_navigation_pkg/offroad_drive"
        ...
        void init(){
            if(!initialized_){
                stateList_ = { {autonomous, std::make_shared<SysCtrl::AutoDriveCtrl>(this->shared_from_this(), AUTO_DRIVE_TOPIC)},
                           ...
                           {offroad, std::make_shared<SysCtrl::OffroadDriveCtrl>(this->shared_from_this(), OFFROAD_DRIVE_TOPIC)} };
