...
# offroad_navigation_pkg
OFFROAD_NAVIGATION_PKG_NS = "/deepracer_offroad_navigation_pkg"
OFFROAD_SET_MAX_SPEED_SERVICE = f"{OFFROAD_NAVIGATION_PKG_NS}/set_max_speed"
