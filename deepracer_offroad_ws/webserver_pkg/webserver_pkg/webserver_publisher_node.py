...
class WebServerNode(Node):
    ...
    def __init__(self):
        ...
        # Create a reentrant callback group to call offroad max speed update service.
        set_offroad_max_speed_cb_group = ReentrantCallbackGroup()
        self.get_logger().info("Create offroad set max speed service client: "
                               f"{OFFROAD_SET_MAX_SPEED_SERVICE}")
        self.set_offroad_max_speed_cli = self.create_client(SetMaxSpeedSrv,
                                                            OFFROAD_SET_MAX_SPEED_SERVICE,
                                                            callback_group=set_offroad_max_speed_cb_group)
        self.wait_for_service_availability(self.set_offroad_max_speed_cli)
